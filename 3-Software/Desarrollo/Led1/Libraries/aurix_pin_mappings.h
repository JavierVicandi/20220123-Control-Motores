...
// p00_5
#define IFXCFG_PORT_LED1_GREEN                  IfxPort_P00_5
#define IFXCFG_PORT_LED1_GREEN_MODE             IfxPort_Mode_outputPushPullGeneral
#define IFXCFG_PORT_LED1_GREEN_PAD_DRIVER       IfxPort_PadDriver_cmosAutomotiveSpeed4


/* Generic port I/O configuration */

#define IFXCFG_P00_5_IO_CONFIG                  { &IFXCFG_PORT_LED1_GREEN, IFXCFG_PORT_LED1_GREEN_MODE, IFXCFG_PORT_LED1_GREEN_PAD_DRIVER }
